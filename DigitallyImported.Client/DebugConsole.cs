...
namespace DigitallyImported.Client
{
    ...
    public class DebugConsoleWrapper : System.Windows.Forms.Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.OutputView.Size = new System.Drawing.Size(604, 330);
        ...
        public void CreateEventRow()
        {
            ...
            if (OutputView.InvokeRequired)
                OutputView.Invoke(new MethodInvoker(delegate() { OutputView.Items.Add(elem); }));
            else
                this.OutputView.Items.Add(elem);
	...
	sealed class DebugConsole : TraceListener
	{
		...
		{   
            ...
            if (DebugForm.InvokeRequired)
                DebugForm.Invoke(new MethodInvoker(DebugForm.UpdateCurrentRow));
            else
